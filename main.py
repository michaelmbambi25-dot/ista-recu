...
SENDER_EMAIL = "stephaniepfiti@gmail.com"

# E-mail de l'autorité qui recevra les alertes de fraude
AUTHORITY_EMAIL = "michaelmbambi25@gmail.com"  # Modifiez si besoin
...
CARTOGRAPHIE_ETUDIANTS = {
    # Électronique (Etri)
    ("matricule_Etri", "L3"): ("MBAMBI YABU Michael", "L3 Électronique"),
    ("matricule_Etri", "L1"): ("NLEVO MABIALA Jean", "L1 Électronique"),
